def Tetris(): 
    ...
    class Controller(object):
        def __init__(self):
            ...
            pygame.init()
            pygame.mixer.music.load('Music/Tetris.mp3') #cargamos la música
            pygame.mixer.music.set_volume(0.3) #establecemos el volumen al 30%
        ...
        def displayScore(self):
            ...
            textSurf2, textRect2 = self.textObjects('Siguiente Pieza:', font)
        ...
        def input(self):
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    elif event.key == pygame.K_UP:  self.m_rotate = True
